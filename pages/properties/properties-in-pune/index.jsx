						...
						<div className="col-12">
							<div className="text-center">
								<h1 className="text-30 fw-600">
									...
									{filteredProperties.length > 1 ? 'Properties' : 'Property'} in{' '}
									{!locationsToBeFiltered.length ? 'Pune' : locationsToBeFiltered}
								</h1>
							</div>
							{/* End text-center */}
						</div>
				...
				<div className="container">
					<div className="row y-gap-30">
						<div className="col-xl-3">
							<aside className="sidebar y-gap-40 xl:d-none search-filter-sidebar sidebarEn">
								<Sidebar
