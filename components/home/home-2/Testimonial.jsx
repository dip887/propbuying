...
const rndInt = randomIntFromInterval(4, 5);
...
const Testimonial = () => {
	const [testitmonials, setTestitmonials] = useState([]);

	useEffect(() => {
		(async function () {
			const data = await sanityClient.fetch(GET_TESTIMONIALS);
			setTestitmonials(data);
		})();
	}, []);
	return (
		<>
