  ...
  return (
    <>
      <section className="masthead -type-9">
                  ...
                  <div className="col-xl-9">
                    <div className="text-center">
                      <div
                        ...
                        data-aos-delay="100"
                      >
                        PropBuying.com #RealtySimplified
                      </div>
                      <h1
                        ...
                        data-aos-delay="300"
                      >
                        Lets find a home that suits your lifestyle
                      </h1>
                    </div>
                  </div>
                </div>
        ...
        <div className="container">
          <div className="mainSearch-wrap bg-white shadow-1 rounded-2">
            <MainFilterSearchBox />
            {/* End tab-filter */}
          </div>
        </div>
